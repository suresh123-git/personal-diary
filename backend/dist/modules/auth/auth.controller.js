...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Register a new magical user account' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Authenticate user and return JWT tokens' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Refresh access token using valid refresh token' }),
